    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-2xl mx-auto bg-gray-900 p-8 rounded-lg shadow-xl">
        ...
        <div className="text-amber-300 bg-amber-950/50 p-4 rounded-md mb-8">
          <p className="font-medium">Important Note About Image Location:</p>
          <p className="mt-1">
            Images must be in the <code className="bg-gray-800 px-1">/public/images/</code> folder to be detected. 
            If you've uploaded files to the root directory, please move them to the correct folder.
          </p>
        </div>
